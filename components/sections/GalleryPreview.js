        ...
        <motion.div initial={{ opacity:0, y:24 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }}
          ...
          <div>
            ...
            <p className="font-body text-ink/55 mt-3 max-w-md">
              Skincare tips, treatment insights, and patient transformations — follow {siteConfig.instagramHandle}
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-10">
          {siteConfig.galleryPosts.slice(0, 6).map((post, i) => (
            <motion.a
              ...
              style={{ background: `linear-gradient(135deg, rgba(7,14,45,0.85), rgba(14,165,160,0.15))` }}
            >
              {/* Emoji thumb */}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-navy-900/90 to-transparent">
                <div className="flex items-center justify-between">
                  <span className="font-heading text-xs text-white/80 font-medium truncate pr-2">{post.caption}</span>
              ...
              {/* Category badge */}
              <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full text-xs font-heading font-semibold"

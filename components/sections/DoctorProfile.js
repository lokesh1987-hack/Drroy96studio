        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <div className="flex items-start gap-5 mb-6">
                <div
                  className="w-24 h-24 rounded-2xl flex items-center justify-center text-5xl shrink-0 animate-float"
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(14,165,160,0.25), rgba(212,168,67,0.1))",
                ...
                <div>
                  <div className="font-display text-white text-xl font-semibold mb-1">
                    {siteConfig.name}
                  </div>
                  <div
                ...
                {siteConfig.credentials.map((c, index) => (
                  ...
                  >
                    ...
                    <span className="flex items-center justify-start gap-1">
                      {index === siteConfig.credentials.length - 1 && (
                        <img
                          src="https://flagcdn.com/w20/gb.png"
                          alt="UK Flag"
                          className="w-5 h-5s object-contain border border-white m-2"
                        />
                      )}
                      {c}
                    </span>
          ...
          >
            ...
            <p className="font-body font-light text-white/65 text-lg leading-relaxed mb-4">
              Dr. Roy brings over 8 years of expertise in advanced aesthetic
              dermatology. Practicing at Skin Solution, he combines medical
              precision with a patient-first philosophy.
            </p>
            <p className="font-body font-light text-white/55 leading-relaxed mb-8">
              From non-surgical PRP hair restoration to advanced acne management
              and skin brightening protocols, Dr. Roy crafts personalized
              treatment plans guided by evidence-based medicine and ongoing
              research.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {siteConfig.locations.map((l) => (
                <div key={l.city} className="glass-card p-4">
                  <div className="font-display text-white text-sm font-semibold mb-1">
                    {l.label}
                  </div>
                  <div className="font-body text-xs text-white/50 mb-2">
                    {l.hours}
                  </div>
                  {l.isPrimary && (
                    <span

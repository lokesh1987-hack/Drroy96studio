...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top info bar */}
      <div
        className="hidden md:flex items-center justify-between bg-navy-900 px-8 py-2 text-xs font-heading"
        style={{ background: "#070e2d" }}
      >
      ...
      >
        <div className="wrap px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            {/* <div
              className="w-10 h-10 px-3 rounded-xl flex items-center justify-center font-display text-white font-bold text-sm shadow-glow-teal"
              style={{
            ...
            <div>
              ...
              <div
                className={cn(
                  ...
                  isTransparent ? "text-teal-300" : "text-teal",
                )}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={cn(
                "lg:hidden w-9 h-9 flex items-center justify-center rounded-full border transition-colors",
                isTransparent
                  ? "border-white/30 text-white"
                  : "border-teal/30 text-ink",
              )}
            >
          ...
          <>
            ...
            >
                ...
                {navLinks.map((l, i) => (
                  ...
                  >
                    <Link
                      ...
                      onClick={() => setOpen(false)}
                      className={cn(
                        "block px-4 py-3 font-heading text-sm font-medium rounded-xl transition-colors",
                        path === l.href
                          ? "text-teal bg-teal/10"
              ...
              <div className="mt-auto p-6 border-t border-white/10 space-y-3">
                ...
                <a
                  href={`tel:${siteConfig.phone}`}
                  className="btn-outline w-full justify-center text-white border-white/30"
                >
